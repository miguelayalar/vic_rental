...
rents_loc <- tempfile(fileext = ".xlsx", pattern = paste0("LGA_quarterly_median_rents_","2023 Q4_"), tmpdir = "C:\\Users\\MAyala\\Desktop\\shiny\\Housing db\\data-raw")
...
#convert to tsibble
vic_rents_ts <- vic_rents |> #filter(series == "Median") %>% 
...
#export clean data
write_csv(vic_rents_ts,"data/Median Weekly Rents_202312.csv")
